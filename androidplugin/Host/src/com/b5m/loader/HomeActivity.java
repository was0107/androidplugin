...
/**
 * Created by boguang on 14/12/26.
 */
    ...
    protected void onResume() {
        ...
        if (site.length() > 0) {
            ...
            try {
                ...
                String url = MyApplication.PRIMARY_SCHEME + "://" + lastSite.fragments()[0].getHost();
                lastUrl.setText(url);
            }
        }
    }
...
//                siteUrl.setText("https://raw.github.com/mmin18/AndroidDynamicLoader/master/site/helloworld/site.txt");
                ...
                siteUrl.setText("https://raw.githubusercontent.com/was0107/androidplugin/master/androidplugin/site/develop/site2.txt");
                findViewById(R.id.go).performClick();
            } else if (v.getId() == R.id.go_bitmapfun) {
                siteUrl.setText("https://raw.githubusercontent.com/was0107/androidplugin/master/androidplugin/site/develop/site1.txt");
//                siteUrl.setText("https://raw.github.com/mmin18/AndroidDynamicLoader/master/site/helloworld/site.txt");
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String url = MyApplication.PRIMARY_SCHEME + "://" + fSite.fragments()[0].getHost();
